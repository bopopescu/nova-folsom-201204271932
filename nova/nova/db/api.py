...
def phy_pxe_ip_get(context, id, session=None):
    return IMPL.phy_pxe_ip_get(context, id, session)
...
def phy_interface_get(context, id, session=None):
    return IMPL.phy_interface_get(context, id, session)
...
def phy_interface_destroy(context, id):
    return IMPL.phy_interface_destroy(context, id)
...
def phy_interface_set_vif_uuid(context, id, vif_uuid):
    return IMPL.phy_interface_set_vif_uuid(context, id, vif_uuid)
...
def phy_deployment_get(context, id, session=None):
    return IMPL.phy_deployment_get(context, id, session)


def phy_deployment_destroy(context, id):
    return IMPL.phy_deployment_destroy(context, id)
