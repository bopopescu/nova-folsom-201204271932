...
# disk/nbd.py can comflict with phy_deploy_work on qemu-nbd. So do not use cow.
...
def _stop_per_host_pxe_server(tftp_root, vlan_id):
    ...
    vlan.ensure_no_vlan(vlan_id, FLAGS.physical_pxe_parent_interface)    
...
class PXE:
    ...
    def _inject_to_image(self, context, target, host, inst, network_info):
    ...
    def create_image(self, var, context, image_meta, host, instance):
        ...
        self._inject_to_image(context, image_path, host, instance, network_info)
    ...
    def activate_bootloader(self, var, context, host, instance):
        ...
        deployment_id = bmdb.phy_deployment_create(context, deployment_key, image_path, pxe_config_path, root_mb, swap_mb)
    ...
    def deactivate_bootloader(self, var, context, host, instance):
        ...
        if FLAGS.physical_pxe_vlan_per_host:
            _stop_per_host_pxe_server(tftp_root, host['pxe_vlan_id'])
